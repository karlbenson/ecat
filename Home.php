        ...
        <div class="container-fluid">
          ...
          <div class="panel panel-default" style="padding-bottom:10px;">
            ...
            <div class="panel-body row" style="margin:0px; padding:5px 10px;">
              ...
              <div class="col-md-3"><?php echo ' '.$CSF_HBILL_SUM.'.00';
			  ?></div>
            </div>
            <div class="panel-body row" style="margin:0px; padding:5px 10px;">
              <div class="col-md-3" >Supplies</div>
              <div class="col-md-3"><?php echo ' '.$CSF_SUPP_SUM.'.00';
			  ?></div>
            </div>
			<div class="panel-body row" style="margin:0px; padding:5px 10px;">
              <div class="col-md-3" >Laboratory</div>
              <div class="col-md-3"><?php echo ' '.$CSF_LAB_SUM.'.00';
			  ?></div>
            </div>
			<div class="panel-body row" style="margin:0px; padding:5px 10px;">
              <div class="col-md-3" ><b>Total</b></div>
              <div class="col-md-3"><b><?php echo ' '.$CSF_TOT.'.00';
			  ?></b></div>
            </div>
          </div>

<?php
	...
	echo 
	'<div id="heading" style="background: linear-gradient(to bottom right, rgba(92, 184, 92, 0.9) 20%, rgba(92, 184, 92, 0) 100%); padding: 10px; width: calc(100% - 100px); height:60px; margin-bottom: 10px;">
		<div>

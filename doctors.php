    ...
    <div class="container-fluid" >
      ...
      if($DEFAULT==0){
        if ($output->num_rows > 0) {
          ...
          echo '<div class="col-md-4 hide_section" style="float:left;"><b>'.'Address'.'</b></div>';
          ...
          while($dataline = $output->fetch_assoc()) { 
            ...
            echo '<div class="row">';
                ...
                echo '<div class="col-md-4 hide_section" style="float:left;">'.$dataline["ADDRESS"].'</div>';
      ...
      echo '<button class="btn btn-default" id="del_button" value="doctors" data-toggle="modal" data-target="#confirm_this" style="margin-left:15px;"> <span class="fa fa-trash" style="font-size:15px;"></span> Delete </button>';

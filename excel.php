												...
												if (!isset($_GET["table"])) {
													...
													if($_GET["table"]=="doctor"){
														...
														$objPHPExcel->setActiveSheetIndex(0)
												            ...
												            ->setCellValue('J1', 'Surgery Address')
												            ->setCellValue('K1', 'Surgery Date')
												            ->setCellValue('L1', 'Remarks')
												            ->setCellValue('M1', 'Internist 1 Name')
												            ->setCellValue('N1', 'Internist 2 Name')
												            ->setCellValue('O1', 'Internist 3 Name')
												            ->setCellValue('P1', 'Anesthesiologist')
												            ->setCellValue('Q1', 'IOL Power')
												            ->setCellValue('R1', 'PC IOL')
												            ->setCellValue('S1', 'PC LAB')
												            ->setCellValue('T1', 'PC PF')
												            ->setCellValue('U1', 'Sponsored IOL')
												            ->setCellValue('V1', 'Misc. Sponsored')
												            ->setCellValue('W1', 'CSF Hosp. Bill')
												            ->setCellValue('X1', 'CSF Supplies')
												            ->setCellValue('Y1', 'CSF Laboratory')
												            ->setCellValue('Z1', 'NDDCH RA')
												            ->setCellValue('AA1', 'NDDCH Zeiss')
												            ->setCellValue('AB1', 'NDDCH Supplies')
												            ->setCellValue('AC1', 'LF Prof. Fee')
												            ->setCellValue('AD1', 'LF CPC');
													    $i=2;
														while($dataline = $output->fetch_assoc()) { 

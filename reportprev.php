						...
						<form method="post" action="reportprev.php?printpage=print" id="reprep">
							...
							?>
								...
								<?php if(isset($_POST["Month"])){
									...
									echo '<input name="Month" value="'.$Month_opt.'"/>';
								}?>
								<?php if(isset($_POST["Quarter"])){
									$Quarter_opt = $_POST['Quarter'];
									echo '<input name="Quarter" value="'.$Quarter_opt.'"/>';
								}?>		
							</div>
						</form>
					</div>
					...
					if($_POST['reptype']=="Yearly"){
						...
						if(isset($_POST['Month'])){
							...
							if($_POST['Quarter']=="Q1"){
								$prevmonth="1";
								$currmonth="3";
							}else if($_POST['Quarter']=="Q2"){
								$prevmonth="4";
								$currmonth="6";
							}else if($_POST['Quarter']=="Q3"){
								$prevmonth="7";
								$currmonth="9";
							}else if($_POST['Quarter']=="Q4"){
								$prevmonth="10";
								$currmonth="12";
							}else
							$currmonth = $_POST['Quarter'];
							$S_query = "SELECT * FROM SURGERY s, DOCTOR d where s.SURG_LICENSE_NUM = d.DOC_LICENSE_NUM  AND SURG_DATE BETWEEN '".$curryear."-".$prevmonth."-1' AND '".$curryear."-".$currmonth."-31' order by s.SURG_DATE desc";
						}
...
<?php					//COMMA PORTION
				...
				$strQuery = "SELECT P.PRE_VA_NO_SPECT_LEFT, COUNT(*) AS freq FROM EYEPATIENT P,SURGERY S WHERE S.PAT_ID_NUM=P.PAT_ID_NUM AND SURG_DATE BETWEEN '".$curryear."-".$prevmonth."-1' AND '".$curryear."-".$currmonth."-31' GROUP BY PRE_VA_NO_SPECT_LEFT";
				...
				$strQuery = "SELECT P.PRE_VA_NO_SPECT_RIGHT, COUNT(*) AS freq FROM EYEPATIENT P,SURGERY S WHERE S.PAT_ID_NUM=P.PAT_ID_NUM AND SURG_DATE BETWEEN '".$curryear."-".$prevmonth."-1' AND '".$curryear."-".$currmonth."-31' GROUP BY PRE_VA_NO_SPECT_RIGHT";
				...
				$strQuery = "SELECT P.POST_VA_NO_SPECT_LEFT, COUNT(*) AS freq FROM EYEPATIENT P,SURGERY S WHERE S.PAT_ID_NUM=P.PAT_ID_NUM AND SURG_DATE BETWEEN '".$curryear."-".$prevmonth."-1' AND '".$curryear."-".$currmonth."-31' GROUP BY POST_VA_NO_SPECT_LEFT";
				...
				$strQuery = "SELECT P.POST_VA_NO_SPECT_RIGHT, COUNT(*) AS freq FROM EYEPATIENT P,SURGERY S WHERE S.PAT_ID_NUM=P.PAT_ID_NUM AND SURG_DATE BETWEEN '".$curryear."-".$prevmonth."-1' AND '".$curryear."-".$currmonth."-31' GROUP BY POST_VA_NO_SPECT_RIGHT";
				...
				if ($result) {
					...
					$arrData = array(
						"chart" => array(
						  "caption" => "Frequency of Procedure types",
						  "showValues" => "1",
						  "theme" => "zune"
						)
					);
					...
					$columnChart = new FusionCharts("pie2d", "myFirstChart4" , 500, 300, "procgraph", "json", $jsonEncodedData);
				...
				?>
						...
						<div  style="float:left; width:100%;">
							...
							<div style="padding:20px;">
								<div><strong>II. </strong>Procedures given</div>
							</div>
							
									
									<div style="width:100%; float:left; text-align:center;">
									<div class="container-fluid" style=" min-width: 750px; ">
										<div id="procgraph" style="width:100%;"></div>
									</div>
									</div>
										...
										<div id="box" style="min-height:0px; margin:0px; background-color:#ffffff; float:left; width:100%;">
											...
											<?php
												...
												echo '<div class="container-fluid" style="padding:20px 20px;">
														...
														<div class="well" style="width: 100%; float: left; color:#337ab7; font-weight:bold; text-align:center;">Financial Report of ';
														 
														if($_POST['reptype']=="Yearly"){
															$dateName = date('Y', mktime(0, 0, 0, $currmonth,1, $curryear));
														}else if($_POST['reptype']=="Quarterly"){
															$dateName = $_POST["Quarter"];
														}else if($_POST['reptype']=="Monthly"){
												...
												echo '<div style="width:100%;">
													...
													<div  style="float:left; width:100%;">
													<div class="panel panel-default" style="padding-bottom:10px;">
														<div class="panel-heading " style="color:#337ab7;">Procedure Given</div>
														<div class="panel-body" style="margin:0px; padding:5px 10px; width:100%;">
													...
													<div class="well" style="padding:15px; background-color:#337ab7; color:#ffffff; float:left; width:100%; margin:0px;"><strong>Financial Information by Type of Anesthesia, Philhealth and Procedure</strong>
													</div>
											...
											//MYSQL SECTION END
												...
												if ($output->num_rows>0) {
													...
													echo 	'<tr>
																...
																<td><b>'.number_format($PC_COL_SUM, "2").'</b></td>
																<td><b>'.$dataline["SPO_IOL"].'</b></td>
																<td><b>'.$dataline["SPO_OTHERS"].'</b></td>
																<td><b>'.number_format($SPO_COL_SUM, "2").'</b></td>

...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="references/datatables.min.css"/>
		<script type="text/javascript" src="references/datatables.min.js"></script>
	</head>
										...
										<?php //CODE SECTION STARTS HERE
											...
											if($DEFAULT==0){
												...
												if ($output->num_rows > 0) {
													...
													//HEADER
													echo'
													<table id="docdat" class="table table-striped row">
														<thead>
															<tr id="tophead">
																<td>Last Name</td>
																<td>First Name</td>
													...
													//CONTENT
															while ($row=$output->fetch_assoc()) {
																echo "<tr>
																	...
																	<td>".$row['ADDRESS']."</td>
																	<td style='text-align:center'><a href=".'doctors.php'.'?profilepage='.$row["DOC_LICENSE_NUM"].">see more</a></td>
																</tr>";
															}
													//CONTENT END
													echo '</table>';

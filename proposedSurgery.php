										...
										<?php //CODE SECTION STARTS HERE
											...
											if($DEFAULT==0){
												...
												if ($output->num_rows>0) {
													...
													//NEW CODES
													echo '<table id="example" class="table table-bordered table-responsive table-hover text-center" cellspacing="0" width="100%">
															<thead style="background:#5cb85c">
																<th style="color:#ffffff"><center>Date</center></th>
																<th style="color:#ffffff"><center>Case No.</center></th>
																<th style="color:#ffffff"><center>Patient</center></th>
																<th style="color:#ffffff"><center>Surgeon</center></th>
																<th></th>
															</thead>
															<tbody>';
													while($dataline = $output->fetch_assoc()) { 
														echo 	'<tr>
																	...
																	<td><a href="'.'surgery.php'.'?profilepage='.$dataline["CASE_NUM"].'">See Full Details</a></td>
																</tr>';
													}
													echo	'</tbody>
														</table>';
